            ...
            {yearReports.map((report: MonthlyReport) => {
              ...
              return (
                <Link key={report.id} href={`/dashboard/records/${report.id}`}>
                  <Card className="hover:shadow-md transition-shadow cursor-pointer h-full bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                    <CardContent className="p-4">
                      ...
                      <p className="text-sm text-amber-700 mt-2 line-clamp-3">
                        {report.content}
                      </p>
                    </CardContent>
                  </Card>
